...
public class Rook extends Piece {
    ...
    public Rook(int x, int y, boolean is_white, String file_path, Board board, int capturePoints)
    {
        super(x,y,is_white,file_path, board, capturePoints, "R");
    }
    ...
    public int canMove(int destination_x, int destination_y)
    {
        ...
        //difference variables tell how far to go
